      ...
      <>
        <div className="md:container md:pt-6">
          <div className="md:rounded-xl overflow-hidden">
            <div 
              className="aspect-[4/3] md:h-auto md:aspect-[21/9] md:max-h-[500px] lg:max-h-[560px] w-full overflow-hidden cursor-pointer"
        ...
        >
          <div className="flex">
            {images.map((image, index) => (
              <div
                key={index}
                className="flex-none w-full aspect-[4/3] md:h-auto md:aspect-[21/9] md:max-h-[500px] lg:max-h-[560px]"
