      ...
      <footer className="bg-card border-t border-border py-8">
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <nav aria-label="Stopka" className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-muted-foreground [&>a]:inline-flex [&>a]:items-center [&>a]:min-h-[40px] [&>a]:md:min-h-0 [&>button]:inline-flex [&>button]:items-center [&>button]:min-h-[40px] [&>button]:md:min-h-0">
