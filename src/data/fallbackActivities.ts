...
export const fallbackActivities: Activity[] = [
  {
    ...
    "experiencePoints": [
      "Kilka dni pełnych spektakli plenerowych w klimatycznym parku",
      "Warsztaty teatralne i animacje dla dzieci w przerwach",
    ...
    "reviews": [
      {
        "author": "Anna M.",
        "rating": 4,
        "text": "Miło spędzony czas z rodziną. Polecam jako alternatywę na deszczowy dzień.",
  ...
  },
  {
    ...
    "estimatedTime": "2–4 godziny",
    "experiencePoints": [
      "Tworzenie tradycyjnych ozdób wielkanocnych pod okiem instruktorów",
      "Malowanie pisanek i dekorowanie mazurków",
      "Dzieci zabierają swoje prace do domu"
    ],
    "reviews": [
      {
        "author": "Tomek K.",
        "rating": 5,
        "text": "Warsztaty prowadzone z pasją. Dzieci wróciły dumne ze swoich prac!",
        "date": "2 tygodnie temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "estimatedTime": "2–4 godziny",
    "experiencePoints": [
      "Nocne zwiedzanie ZOO z profesjonalnym przewodnikiem",
      "Obserwacja nocnych zachowań zwierząt przy latarkach",
      "Niezapomniana przygoda dla starszych dzieci i młodzieży"
    ],
    "reviews": [
      {
        "author": "Ewa S.",
        "rating": 5,
        "text": "Dzieci były zachwycone! Zwierzęta blisko, dużo do zobaczenia. Wróciliśmy po 3 godzinach zmęczeni, ale szczęśliwi.",
        "date": "2 tygodnie temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "estimatedTime": "2–4 godziny",
    "experiencePoints": [
      "Pokazy eksperymentów fizycznych i chemicznych na żywo",
      "Warsztaty 'zrób to sam' z prostymi doświadczeniami",
      "Stoiska organizacji naukowych i edukacyjnych"
    ],
    "amenities": [
      "toilets",
      "food-onsite",
  ...
  },
  {
    ...
    "experiencePoints": [
      "Bezpieczna nawierzchnia amortyzująca upadki",
      "Oddzielne strefy dla maluchów i starszych dzieci",
      "Regularne kontrole bezpieczeństwa i czystości",
      "Ławki i zadaszenia dla opiekunów"
    ],
    "amenities": [
      "stroller",
      "seating",
  ...
  },
  {
    ...
    "reviews": [
      ...
      },
      {
        "author": "Piotr L.",
        "rating": 4,
        "text": "Bardzo fajne miejsce na rodzinny spacer. Dużo cienia i ławek do odpoczynku. Polecam zabrać prowiant.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Kasia D.",
        "rating": 4,
        "text": "Świetna atrakcja, choć w weekendy bywa tłoczno. Warto przyjść w tygodniu.",
  ...
  },
  {
    ...
    "estimatedTime": "2–4 godziny",
    "experiencePoints": [
      "Ponad 450 interaktywnych stanowisk doświadczalnych na dwóch piętrach",
      "Planetarium z projekcjami filmów edukacyjnych na kopule",
      "Warsztaty i pokazy naukowe prowadzone przez animatorów",
      "Strefa dla najmłodszych 'Bzzz!' z eksponatami sensorycznymi"
    ],
    ...
    "reviews": [
      {
        "author": "Bartek N.",
        "rating": 5,
        "text": "Interaktywne wystawy naprawdę angażują dzieci. Mój 7-latek nie chciał wychodzić!",
        "date": "2 tygodnie temu"
      },
      {
        "author": "Joanna P.",
        "rating": 5,
        "text": "Bardzo dobrze przygotowane dla rodzin. Są przewodniki dla dzieci i warsztaty w weekendy.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Michał R.",
        "rating": 4,
        "text": "Ciekawe eksponaty, ale młodsze dzieci (poniżej 5 lat) mogą się nudzić. Dla starszych super.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "experiencePoints": [
      "Interaktywne wystawy angażujące wszystkie zmysły",
      "Warsztaty edukacyjne dostosowane do różnych grup wiekowych",
      "Przewodniki i materiały przygotowane specjalnie dla rodzin z dziećmi",
      "Strefy odpoczynku dla rodziców z widokiem na ekspozycję"
    ],
  ...
  },
  {
    ...
    "estimatedTime": "1–2 godziny",
    "experiencePoints": [
      "Atrakcja dostosowana do różnych grup wiekowych",
    ...
    "reviews": [
      ...
      },
      {
        "author": "Natalia F.",
        "rating": 4,
        "text": "Fajne miejsce, dzieci dobrze się bawiły. Warto sprawdzić aktualne godziny na stronie.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Robert G.",
        "rating": 5,
        "text": "Ciekawa atrakcja, zwłaszcza dla dzieci w wieku 5-10 lat. Spędziliśmy tu prawie 2 godziny.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "experiencePoints": [
      "Malownicze ścieżki spacerowe wśród zieleni",
      "Miejsca do odpoczynku z ławkami i altankami",
      "Możliwość obserwowania przyrody i ptaków",
      "Bezpieczne alejki do jazdy na rowerze i hulajnodze"
    ],
    "reviews": [
      {
        "author": "Aleksandra H.",
        "rating": 5,
        "text": "Piękne miejsce na rodzinny spacer. Mnóstwo zieleni i przestrzeni do biegania.",
        "date": "2 tygodnie temu"
      },
      {
        "author": "Łukasz C.",
        "rating": 4,
        "text": "Idealny na weekendowy piknik z dziećmi. Są place zabaw i ścieżki rowerowe.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Monika O.",
        "rating": 4,
        "text": "Spokojne miejsce, dobre na spacer z wózkiem. Alejki szerokie i zadbane.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "experiencePoints": [
      ...
      "Wszystkie materiały i narzędzia w cenie warsztatu",
    ...
    "reviews": [
      ...
      },
      {
        "author": "Tomek K.",
        "rating": 5,
        "text": "Doskonała organizacja, małe grupy. Instruktor poświęcał uwagę każdemu dziecku.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Ewa S.",
        "rating": 4,
        "text": "Kreatywna zabawa i edukacja w jednym. Na pewno wrócimy na kolejne zajęcia.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "experiencePoints": [
      "Profesjonalny sprzęt dostosowany do dzieci",
      "Wykwalifikowani instruktorzy dbający o bezpieczeństwo",
      "Zajęcia w grupach wiekowych dla optymalnej zabawy",
      "Szatnie i zaplecze sanitarne dla rodzin"
    ],
    "reviews": [
      {
        "author": "Marta W.",
        "rating": 5,
        "text": "Dzieci się świetnie bawiły! Instruktorzy bardzo pomocni i cierpliwi.",
        "date": "2 tygodnie temu"
      },
      {
        "author": "Piotr L.",
        "rating": 4,
        "text": "Profesjonalne podejście do bezpieczeństwa. Sprzęt w dobrym stanie.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Kasia D.",
        "rating": 5,
        "text": "Świetna zabawa dla aktywnych dzieci. Warto zarezerwować termin wcześniej.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
    ...
    "reviews": [
      {
        "author": "Kamil J.",
        "rating": 5,
        "text": "Bezpieczny, czysty i dobrze utrzymany plac zabaw. Dzieci mogą się tu bawić godzinami.",
        "date": "2 tygodnie temu"
      },
      {
        "author": "Natalia F.",
        "rating": 4,
        "text": "Fajne urządzenia dla różnych grup wiekowych. Jest też strefa dla maluszków.",
        "date": "1 miesiąc temu"
      },
      {
        "author": "Robert G.",
        "rating": 4,
        "text": "Spędziliśmy tu całe popołudnie. Jedyny minus — brak toalety w pobliżu.",
        "date": "2 miesiące temu"
      }
    ],
    "amenities": [
  ...
  },
  {
    ...
    "experiencePoints": [
      "Dzieci obserwują zwierzęta z różnych kontynentów w naturalnych wybiegach",
      "Dostępne tablice edukacyjne i quizy przyrodnicze przy każdym wybiegu",
      "Strefa malucha z łagodnymi zwierzętami do głaskania",
      "Na terenie znajdują się place zabaw i strefy piknikowe"
    ],
    "reviews": [
      {
  ...
  },
  {
    ...
    "estimatedTime": "2–3 godziny",
    "experiencePoints": [
      "Trasa turystyczna prowadzi przez zabytkowe komory solne i kaplice",
      "Podziemne jezioro i spektakularne rzeźby solne",
      "Specjalna trasa rodzinna z quizem i grą edukacyjną dla dzieci",
      "Stała temperatura 14°C — warto zabrać ciepłą bluzę"
    ],
  ...
  },
  {
    ...
    "experiencePoints": [
      "Krótkie, ale ekscytujące wejście do legendarnej smoczej jamy",
      "Dzieci poznają legendę o Smoku Wawelskim",
      "Pomnik ziejącego ogniem smoka tuż przy wyjściu"
    ],
    "reviews": [
      {
        "author": "Ewa S.",
  ...
  },
  {
    ...
    "experiencePoints": [
      "Rejs widokowy po historycznej Motławie",
      "Widok na Żuraw, Wyspę Spichrzów i Stare Miasto z wody",
      "Rejsy trwają ok. 45 minut z komentarzem przewodnika"
    ],
    "reviews": [
      {
        "author": "Marta W.",
